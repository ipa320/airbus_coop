...
class WaitForTrackingInit(ssm_core.AirState):
...
class GetObjectPosition(ssm_core.AirState):
    ...
    def execute(self, ud):
        ...
        MoveOffset     = ReadXmlPoint(root.find("Obj"+ud.data["ObjTarget"]))
        self.execution = True
        cpt = 0
        r = rospy.Rate(10)
