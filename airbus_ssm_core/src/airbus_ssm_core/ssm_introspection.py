...
# Topic names
STATUS_TOPIC = '/introspection/container_status'
INIT_TOPIC = '/introspection/container_init'
STRUCTURE_TOPIC = '/introspection/container_structure'
...
class ContainerProxy():
    ...
    """
    def __init__(self, server_name, container, path, update_rate=rospy.Duration(0.2)):
