...
from avancement_mission_plugin.res import R

class AvancementMissionPlugin(plugin.Plugin):
...
if __name__ == "__main__":
    ...
    rospy.init_node("avancement_mission_plugin_node")
    
    a = QApplication(sys.argv)
    
    window = plugin.getStandAloneInstance("avancement_mission_plugin", AvancementMissionPlugin, "en")
    window.setWindowTitle("AvancementMissionPlugin")
    window.show()
    a.exec_()
