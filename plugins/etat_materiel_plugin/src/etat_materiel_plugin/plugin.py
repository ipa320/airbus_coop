...
from etat_materiel_plugin.res import R

class EtatMaterielPlugin(plugin.Plugin):
...
if __name__ == "__main__":
    ...
    rospy.init_node("etat_materiel_plugin_node")
    
    a = QApplication(sys.argv)
    
    window = plugin.getStandAloneInstance("etat_materiel_plugin", EtatMaterielPlugin, "en")
    window.setWindowTitle("EtatMaterielPlugin")
    window.show()
    a.exec_()
